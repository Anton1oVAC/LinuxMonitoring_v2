...
generate_url() {
    if [ $1 -eq 1 ]; then
        echo "$(./create.sh google $(($RANDOM%100+1))).com "
    elif [ $1 -eq 2 ]; then
        echo "$(./create.sh ya $(($RANDOM%100+1))).ru "
    elif [ $1 -eq 3 ]; then
        echo "$(./create.sh apple $(($RANDOM%100+1))).com "
    elif [ $1 -eq 4 ]; then
        echo "$(./create.sh amazon $(($RANDOM%100+1))).com "
    else
        echo " "
    fi
}
